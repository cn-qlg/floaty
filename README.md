...
- **多便签浮动窗口**：拖动 / resize / 单独置顶 / 菜单栏常驻（纯 tray 应用）
- **Markdown 编辑**：checkbox / 列表 / 引用 / 代码块 / 粗斜删除线 / 链接 …… 完整双向 round-trip
...
**86 前端测试 + 14 后端测试** 全绿。macOS/Windows 打包走 GitHub Actions 自动构建。
